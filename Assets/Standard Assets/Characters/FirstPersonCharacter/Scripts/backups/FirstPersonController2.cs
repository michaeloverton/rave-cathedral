...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController2 : MonoBehaviour
    {
        ...
        // For dealing with the funnel slide before track three.
        private bool onSlope; // is on a slope or not
        public float slideFriction = 0.3f; // adjust friction of slope
        private Vector3 hitNormal; //orientation of the slope.
        private float slideSpeed = 100;
        ...
        private void FixedUpdate()
        {
            ...
            // // Deal with slope.
            // // onSlope = shouldSlide && m_CharacterController.isGrounded;
            ...
            //     // Debug.Log("slide dir: " + slideDirection);

            //     m_MoveDir += slideDirection;
            //     // Debug.Log("move dir: " + m_MoveDir);
            ...
            // onSlope = Vector3.Angle(Vector3.up, hitNormal) > m_CharacterController.slopeLimit && m_CharacterController.isGrounded;
            // // Debug.Log("on slope: " + onSlope);
